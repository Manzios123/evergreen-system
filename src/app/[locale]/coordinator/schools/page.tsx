    ...
    },
    {
      ...
      render: (school: School) => (
        <div className="flex space-x-1">
          <Link href={`/coordinator/schools/${school.id}`} className="inline-flex">
            <Button
              size="sm"
              variant="ghost"
          ...
          <Link href={`/coordinator/schools/${school.id}/edit`} className="inline-flex">
            <Button
              size="sm"
              variant="ghost"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Link href="/en/coordinator/schools/new">
          <Button
            variant="default"
          ...
          action={
            !searchTerm && activeFilter === 'active'
              ? {
                  ...
                  onClick: () => window.location.href = '/coordinator/schools/new',
                }
              : {
                  label: 'Clear Filters',
                  onClick: () => {
